...
[`ragnar::MarkdownDocument`](https://ragnar.tidyverse.org/dev/reference/MarkdownDocument.md)
object with the
...
[`markdown_chunk()`](https://ragnar.tidyverse.org/dev/reference/markdown_chunk.md)’s
