...
Source:
[`DESCRIPTION`](https://github.com/tidyverse/ragnar/blob/main/DESCRIPTION)

Kalinowski T, Falbel D (2025). *ragnar: Retrieval-Augmented Generation
(RAG) Workflows*. R package version 0.2.1.9000,
