(function () {
  function initInstance(root) {
    ...
    var save = function (px) { try { localStorage.setItem(key, String(px)); } catch (e) { } };
    var load = function () { try { return parseInt(localStorage.getItem(key) || '', 10); } catch (e) { return NaN; } };
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function () { initAll(); initShortcuts(); }, { once: true });
  } else {
    initAll();
    initShortcuts();
  }
